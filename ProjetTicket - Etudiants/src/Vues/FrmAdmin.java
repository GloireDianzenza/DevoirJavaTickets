...
public class FrmAdmin extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        txtNumTicket.setText(String.valueOf(fm.getNextTicket()));
        
        for(Etat e:fm.getEtats())
        {
    ...
    private void tblUsersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsersMouseClicked
        while(tblTickets.getRowCount() != 0)
        {
            dtmTickets.removeRow(0);
        }
        if(tblUsers.getSelectedRowCount() == 1)
        {
            for(Ticket t:fm.getTicketUser(Integer.parseInt(tblUsers.getValueAt(tblUsers.getSelectedRow(), 0).toString())))
            {
                v = new Vector();
                v.add(t.getIdTicket());
    ...
    private void btnInsererNouveauTicketMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsererNouveauTicketMouseClicked
        ...
        String dateTicket = dtf.format(lct);
        int idEtat = fm.getIdEtat(cboEtatsTickets.getSelectedItem().toString());
        if(tblUsers.getSelectedRowCount() != 1)
        {
            JOptionPane.showMessageDialog(this, "Choisissez votre utilisateur");
        }
        else if(txtNomTicket.getText().compareTo("")==0)
        {
            JOptionPane.showMessageDialog(this, "Choisissez votre nom de ticket");
        }
        else
        {
            int idUser = Integer.parseInt(tblUsers.getValueAt(tblUsers.getSelectedRow(), 0).toString());
            fm.AjouterTicket(idTicket, nomTicket, dateTicket, idUser, idEtat);
            JOptionPane.showMessageDialog(this, "Le nouveau ticket a été ajouté.");
            while(tblTickets.getRowCount() != 0)
            {
                dtmTickets.removeRow(0);
            }
