...
public class FrmConnexion extends javax.swing.JFrame {
    ...
    private void btnConnecterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConnecterMouseClicked
        u = fm.chercherUser(txtLogin.getText(), txtMdp.getText());
        if(txtLogin.getText().compareTo("")==0)
        {
            lblErreur.setText("Veuillez saisir un nom de compte.");
        }
        ...
        else
        {
            ...
            if(u == null)
            {
                lblErreur.setText("Identifiants non reconnus");
            }
            else if(u.getStatutUser().compareTo("user")==0)
            {
                FrmUser frm = new FrmUser(u);
                frm.setVisible(true);
            }
            else
            {
