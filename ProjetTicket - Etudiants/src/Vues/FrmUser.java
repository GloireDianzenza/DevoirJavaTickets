...
public class FrmUser extends javax.swing.JFrame {
    ...
    private void btnModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifierMouseClicked
        ...
        {
            JOptionPane.showMessageDialog(this, "Sélectionnez un seul ticket.");
        }
        else
        {
            fm.addEtat(cboEtatsTickets.getSelectedItem().toString(), Integer.parseInt(tblTickets.getValueAt(tblTickets.getSelectedRow(), 0).toString()));
            JOptionPane.showMessageDialog(this, "Le nouvel état a été ajouté");
            while(tblTickets.getRowCount() != 0)
            {
                dtmTickets.removeRow(0);
            }
            for(Ticket t:fm.getTicketUser(leUser.getIdUser()))
            {
            v = new Vector();
            v.add(t.getIdTicket());
